...
| `r_fog_quality` | `1` | Qualitätsstufe (`0..3`), steuert primär Schritte/Res |
...
| `r_atmos_mode` | `r_fog_backend` | kompatibel, deprecated warning once |
| `r_atmos_historyweight` | `r_fog_history_weight` | kompatibel, deprecated warning once |
| `r_atmos_debug` | `r_fog_debug` | kompatibel, deprecated warning once |
...
Hinweis: Legacy-CVARs bleiben vorerst als Compatibility-Eingänge erhalten, die Laufzeitsteuerung erfolgt aber zentral über `r_fog_*`.
