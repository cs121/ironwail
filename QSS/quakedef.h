...
#define RELIABLE_MTU	(1450-8)	// spike -- was MAX_DATAGRAM, set to <=1024 for nq compat. this is just to avoid fragmentation. low values will increase latency but shouldn't nuke the game.
