...
ibuf.global.rim_params2[3] = CLAMP (0.f, r_rim_debug.value, 3.f);
	...
	R_Shadow_BindProgram ("ALIAS", glprogs.alias[oit][mode][alphatest][md5]);
	R_Shadow_BindUBO ("ALIAS", glprogs.alias[oit][mode][alphatest][md5], FRAME_DATA_UBO_NAME, FRAME_UBO_BINDING);
	R_Shadow_LogReceiverUniformUpload ("ALIAS", glprogs.alias[oit][mode][alphatest][md5]);
