...
extern cvar_t r_caustics_alias;
extern cvar_t r_caustics_debug;
extern cvar_t r_film35_enable;
extern cvar_t r_film35_strength;
extern cvar_t r_film35_weave_px;
extern cvar_t r_film35_rgb_px;
extern cvar_t r_film35_speed;
...
Cvar_RegisterVariable (&r_tonemap_black_lift_strength);
	...
	Cvar_RegisterVariable (&r_caustics_water);
	Cvar_RegisterVariable (&r_caustics_lava);
	Cvar_RegisterVariable (&r_caustics_intensity);
	Cvar_RegisterVariable (&r_caustics_scale);
	Cvar_RegisterVariable (&r_caustics_speed);
	Cvar_RegisterVariable (&r_caustics_alias);
	Cvar_RegisterVariable (&r_caustics_debug);
	Cvar_RegisterVariable (&r_film35_enable);
	Cvar_RegisterVariable (&r_film35_strength);
	Cvar_RegisterVariable (&r_film35_weave_px);
	Cvar_RegisterVariable (&r_film35_rgb_px);
	Cvar_RegisterVariable (&r_film35_speed);
...
Cvar_RegisterVariable (&r_vignette);
	...
	Cvar_RegisterVariable (&r_scene_scale_debug);
	Cvar_RegisterVariable (&r_drs);
	Cvar_RegisterVariable (&r_drs_use_gpu);
	Cvar_RegisterVariable (&r_drs_target_fps);
	Cvar_RegisterVariable (&r_drs_min_scale);
	...
	Cvar_RegisterVariable (&r_drs_step_size);
	Cvar_RegisterVariable (&r_drs_sharpen);
