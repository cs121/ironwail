...
typedef struct texture_s
{
	...
	const struct material_s *material;
...
typedef enum {mod_brush, mod_alias, mod_sprite, mod_glb, mod_ext_invalid, mod_numtypes} modtype_t;
...
#define	MOD_NOSHADOW	512		//don't cast model shadows
