...
cvar_t r_fogvol_testvolumes = { "r_fogvol_testvolumes", "0", CVAR_NONE };
cvar_t r_fogvol_testvolumes_dumpstate = { "r_fogvol_testvolumes_dumpstate", "0", CVAR_NONE };
cvar_t r_fogvol_test_rate = { "r_fogvol_test_rate", "10", CVAR_NONE };
cvar_t r_fogvol_test_every_n_frames = { "r_fogvol_test_every_n_frames", "1", CVAR_NONE };
cvar_t r_fogvol_test_verbose = { "r_fogvol_test_verbose", "0", CVAR_NONE };
