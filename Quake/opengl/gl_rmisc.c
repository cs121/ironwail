...
Cvar_RegisterVariable (&r_drawviewmodel);
        ...
        Cvar_RegisterVariable (&r_clustered_debug_tiles);
	...
	Cvar_RegisterVariable (&r_clustered_debug_repro);
	Cvar_RegisterVariable (&r_clustered_build);
	Cvar_RegisterVariable (&r_clustered_bind);
	Cvar_RegisterVariable (&r_clustered_shade);
