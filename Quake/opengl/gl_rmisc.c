...
Cvar_RegisterVariable (&r_drawviewmodel);
	...
	Cvar_RegisterVariable (&r_clustered_async);
	Cvar_RegisterVariable (&r_clustered_workers);
	Cvar_RegisterVariable (&r_clustered_async_debug);
	Cvar_RegisterVariable (&r_clustered_force_sync);
        ...
        Cvar_RegisterVariable (&r_shadow_csm_debug);
        Cvar_RegisterVariable (&r_shadow_sun_dir);
        Cvar_RegisterVariable (&r_shadow_sun_color);
        Cvar_RegisterVariable (&r_shadow_sun_intensity);
        Cvar_RegisterVariable (&r_sun_fallback);
        Cvar_RegisterVariable (&r_sun_force_fallback);
        Cvar_RegisterVariable (&r_sun_allow_no_sun);
        Cvar_RegisterVariable (&r_sun_distance);
        Cvar_RegisterVariable (&r_sun_debug);
