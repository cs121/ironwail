...
extern cvar_t r_godrays_sky;
extern cvar_t r_godrays_light;
extern cvar_t r_godrays_world;
...
Cvar_RegisterVariable (&r_godrays);
	...
	Cvar_RegisterVariable (&r_godrays_sky);
	Cvar_RegisterVariable (&r_godrays_light);
	Cvar_RegisterVariable (&r_godrays_world);
	Cvar_RegisterVariable (&r_fog_enable);
	Cvar_RegisterVariable (&r_fog_backend);
	...
	Cvar_RegisterVariable (&r_atmos_froxel);
