...
Cvar_RegisterVariable (&r_drawviewmodel);
        ...
        Cvar_RegisterVariable (&r_shadow_debug_dummytex);
        Cvar_RegisterVariable (&r_shadow_debug_source);
        Cvar_RegisterVariable (&r_shadow_debug_nocull);
        Cvar_RegisterVariable (&r_shadow_debug_atlas_overlay);
        Cvar_RegisterVariable (&r_shadow_debug_slot_overlay);
        Cvar_RegisterVariable (&r_shadow_debug_yflip);
        Cvar_RegisterVariable (&r_shadow_debug_std140_dump);
        ...
        Cvar_RegisterVariable (&r_shadow_dlight_aim);
        Cvar_RegisterVariable (&r_shadow_dlight_aim_dist);
        Cvar_RegisterVariable (&r_shadow_dlight_fov);
        Cvar_RegisterVariable (&r_shadow_matrix_debug);
