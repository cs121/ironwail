...
#if defined(USE_SSE2) && (defined(__SSE3__) || defined(_MSC_VER))
	#define USE_SSE3
	#include <pmmintrin.h>	/* SSE3: _mm_hadd_ps */
#endif

#if defined(USE_SSE2) && (defined(__SSE4_1__) || defined(_MSC_VER))
	#define USE_SSE41
	#include <smmintrin.h>	/* SSE4.1: _mm_dp_ps, _mm_blendv_ps */
#endif

#if (defined(__AVX__) && (defined(__GNUC__) || defined(_MSC_VER)))
	#define USE_AVX
	#include <immintrin.h>	/* AVX: _mm256_* */
#endif
