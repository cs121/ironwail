...
int BotCombat_SelectWeapon (struct bot_state_s *bot, edict_t *self, float enemy_dist, qboolean line_of_sight);
int BotCombat_SelectWeaponAvoid (struct bot_state_s *bot, edict_t *self, float enemy_dist, qboolean line_of_sight, int avoid_weapon);
