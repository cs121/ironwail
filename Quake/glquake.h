...
extern  cvar_t  r_lightstyles_zero_cost_debug;
...
void R_ClusterPerf_BeginLightFilter (void);
void R_ClusterPerf_EndLightFilter (void);
void R_ClusterPerf_BeginLightUpload (void);
void R_ClusterPerf_EndLightUpload (void);
void R_ClusterPerf_BeginClusterBindBarrier (void);
void R_ClusterPerf_EndClusterBindBarrier (void);
void R_ClusterPerf_BeginClusterClearGPU (void);
void R_ClusterPerf_EndClusterClearGPU (void);
void R_ClusterPerf_BeginClusterBuildGPU (void);
void R_ClusterPerf_EndClusterBuildGPU (void);
void R_ClusterPerf_BeginShadowDlightGPU (void);
void R_ClusterPerf_EndShadowDlightGPU (void);
void R_ClusterPerf_MarkReason (const char *reason);
...
void R_PerfStats_SetClusterBuildMS (double ms);
void R_PerfStats_SetClusterUploadMS (double ms);
void R_PerfStats_SetClusterIndices (int indices);
void R_PerfStats_SetClusterLights (unsigned int lights);
