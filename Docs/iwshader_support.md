...
| `mask` | Records the chosen channel.【F:Quake/renderer/r_iwshader.c†L736-L758】 | Not read by renderer; only surfaced when dumping.【F:Quake/renderer/r_iwshader.c†L1795-L1797】 | No channel masking logic implemented.
| `tcmod` | Parses scroll/scale/rotate/translate/stretch/turb/envmap modifiers.【F:Quake/renderer/r_iwshader.c†L439-L508】 | Texture-matrix helper honours scroll/scale/rotate/translate for all alignments; world stages pull from world-space bases, while screen-aligned stages operate on NDC scaled by the framebuffer size.【F:Quake/renderer/r_iwshader.c†L1601-L1707】【F:Quake/r_world.c†L170-L212】【F:Quake/shaders/world.vert†L24-L121】 | Stretch/turb/envmap presently ignored for matrices.
| `tcscale` / `tcoffset` | Convenience wrappers for scale/translate tcmods.【F:Quake/renderer/r_iwshader.c†L774-L820】 | Feed into the same texture-matrix pipeline as `tcmod`, producing identical transforms for their tcmod equivalents regardless of alignment.【F:Quake/renderer/r_iwshader.c†L1601-L1707】【F:Quake/r_world.c†L755-L811】 | Effect limited to supported tcmod ops.
| `tcalign` | Accepts world/object/screen.【F:Quake/renderer/r_iwshader.c†L822-L846】 | Runtime implements object/world/screen alignments: world projects via fixed world bases, screen uses clip-space with pixel scaling uniform `ScreenTexScale`.【F:Quake/r_world.c†L170-L212】【F:Quake/gl_rmain.c†L1736-L1758】【F:Quake/shaders/world.vert†L24-L121】 | Non-matrix tcmods (stretch/turb/envmap) remain unhandled.
| `depthwrite` / `depthtest` | Booleans or on/off tokens parsed.【F:Quake/renderer/r_iwshader.c†L872-L919】 | Not consumed by renderer; only emitted when dumping.【F:Quake/renderer/r_iwshader.c†L1753-L1756】 | Depth state still hard-coded elsewhere.
