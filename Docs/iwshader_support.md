...
| `blend` | Handles canned modes and explicit factors.【F:Quake/renderer/r_iwshader.c†L569-L633】 | Base-stage blends now drive GL `glBlendFunc` selection and default depth-write overrides for each drawcall.【F:Quake/r_world.c†L803-L820】【F:Quake/r_world.c†L409-L432】 | Supports canned modes and custom factors for translucent overlays.
| `rgbgen` | Supports vertex/identity/const/entity/wave.【F:Quake/renderer/r_iwshader.c†L634-L676】 | Const and wave modes modulate emissive stage colours at runtime.【F:Quake/r_world.c†L642-L678】 | Vertex/entity remain passthrough until per-vertex colours are exposed.
| `alphagen` | Supports vertex/const/mask/entity/wave.【F:Quake/renderer/r_iwshader.c†L686-L724】 | Const and wave alphagens feed material alpha used for sorting and batching.【F:Quake/r_world.c†L700-L739】 | Vertex/entity remain TODO.
